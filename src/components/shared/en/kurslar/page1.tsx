  ...
  return (
    <div>
        <ul className="flex py-3 px-32 gap-8 bg-gradient-to-r from-secondary to-primary h-15 mt-20">
            <Link to={"/uz"}>Home</Link>
            <li className="list-disc">All Courses</li>
        </ul>
        <h1 className="text-4xl font-semibold px-32 mt-10">All Courses</h1>
        <p className="font-semibold mx-32">We offer a variety of courses to help you learn and grow.</p>
        <div className="flex items-center mt-10 justify-between px-32">
        <h1>Showing <span className="font-semibold">8</span> total results</h1>
        <h1>Sort By:</h1>
        </div>
