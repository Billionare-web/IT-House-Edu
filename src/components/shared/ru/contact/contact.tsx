  ...
  return (
    <div>
        <ul className="flex py-3 px-32 gap-8 bg-gradient-to-r from-secondary to-primary h-15 mt-20">
            <Link to={"/uz"}>Главная</Link>
            <li className="list-disc">Контакты</li>
        </ul>
        ...
        <div className="flex justify-between mt-5 px-32">
            <div>
            <h1 className="font-bold text-4xl">Свяжитесь с нами</h1>
            <h1 className="mt-2">Мы здесь, чтобы помочь вам. Если у вас есть вопросы, не стесняйтесь <br />обращаться к нам.</h1>
            ...
            <div>
                <h1 className="font-bold text-4xl">Форма контакта</h1>
                <Input className="pb-24 pt-5 font-semibold pr-96 mt-3 rounded-xl" placeholder="Задайте вопрос или просто скажите Привет" />
                <Input className="mt-3 rounded-lg" placeholder="Адрес электронной почты" />
                <Input className="mt-3 rounded-lg" placeholder="Ваше имя здесь" />
                <Button className="flex items-center gap-2 mt-5 bg-[#E11D48] rounded-full py-6 px-7 text-white" >Отправить<IoPaperPlaneOutline /></Button>
            </div>
        </div>
    </div>
  )
