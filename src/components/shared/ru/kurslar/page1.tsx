  ...
  return (
    <div>
        <ul className="flex py-3 px-32 gap-8 bg-gradient-to-r from-secondary to-primary h-15 mt-20">
            ...
            <li className="list-disc">Все курсы</li>
        </ul>
        <h1 className="text-4xl font-semibold px-32 mt-10">Все курсы</h1>
        <p className="font-semibold mx-32">Мы предлагаем разнообразие курсов, чтобы помочь вам учиться и развиваться.</p>
        <div className="flex items-center mt-10 justify-between px-32">
        <h1>Показано <span className="font-semibold">8</span> всего результатов</h1>
