      ...
      <div className="flex justify-center mt-14">
        <div className="flex items-center gap-28">
          <div className="column">
            ...
            Popüler Kurslara Göz Atın
            </h1>
            <h4 className="font-semibold text-gray-500">
            Günümüzde yüksek talep gören IT kursları.
            </h4>
          </div>
          <div className="flex">
            <Link to={"/tr/courses"} className="bg-secondary px-4 py-2 rounded-3xl font-semibold ml-1 text-foreground">
            Tümü
            </Link>
