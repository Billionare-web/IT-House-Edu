  ...
  return (
    <div>
        <ul className="flex py-3 px-32 gap-8 bg-gradient-to-r from-secondary to-primary h-15 mt-20">
            ...
            <li className="list-disc">Tüm Kurslar</li>
        </ul>
        <h1 className="text-4xl font-semibold px-32 mt-10">Tüm Kurslar</h1>
        <p className="font-semibold mx-32">Öğrenmenize ve gelişmenize yardımcı olmak için çeşitli kurslar sunuyoruz.</p>
        <div className="flex items-center mt-10 justify-between px-32">
        <h1>Gösteriliyor <span className="font-semibold">8</span> toplam sonuç</h1>
