...
function Treyding() {
  return (
    <div className="">
        ...
        <div>
          <div className=" group grid grid-cols-2 gap-4">
            ...
            <p className = "font-space-grotesque">
                <b className="text-xl font-medium text-green-600 gri tonlamalı group-hover:grayscale-0">
                  "Nur Yatırım"
                </b>{" "}
                - bu dürüst hisse ticareti yapan bir ticaret şirketidir
                ve ticaret eğitim şirketi. Biz
                ticaret{" "}
                <span className="font-bold text-green-600 gri tonlamalı group-hover:grayscale-0">
                  {" "}
                  İslam{" "}
                </span>
                İş sürecimizde bunu finans bazlı yürüteceğiz
                Tüm faaliyetler İslam Kalkınma Bankası bünyesinde açılıyor
                AAOIFI şeriat standardına göre yürütülür. Bundan
                hariç{" "}
                <b className="text-green-600 gri tonlamalı group-hover:grayscale-0">
                  "Nur Yatırım"
                </b>{" "}
                şirket "Dürüst hisse ticaretine dayalı ticaret"
                insanlara eğitim hakkında bilgi vermekle meşgul
                format çevrimiçi ve çevrimdışı olarak gerçekleştirilir.
            </p>
      ...
      <h1 className="px-6 mt-5 text-3xl font-semibold">Beğenebilirsin</h1>
