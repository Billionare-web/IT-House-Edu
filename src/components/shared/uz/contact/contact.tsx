  ...
  return (
    <div>
        ...
        <div className="flex justify-between mt-5 px-32">
            ...
            <h1 className="mt-2">Sizga yordam bera olish uchun bizga qo'ng'iroq qilishingiz mumkin. Agar <br />savolingiz bo'lsa, baxtli bo'ling.</h1>
            ...
            <div>
                ...
                <Input className="pb-24 pt-5 font-semibold pr-96 mt-3 rounded-xl" placeholder="Savol yoki Salom deb ayting" />
                <Input className="mt-3 rounded-lg" placeholder="Elektron pochta manzili" />
                <Input className="mt-3 rounded-lg" placeholder="Ismingizni kiriting" />
                <Button className="flex items-center gap-2 mt-5 bg-[#E11D48] rounded-full py-6 px-7 text-white" >Yuborish<IoPaperPlaneOutline /></Button>
            </div>
        </div>
    </div>
  )
