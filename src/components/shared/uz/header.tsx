  ...
  return (
    ...
    <div className='flex py-3 z-10 fixed px-[70px] -top-1 w-full backdrop-blur-2xl bg-background/70'>
      ...
      <ul className='flex gap-3 items-center font-bold'>
        <Link to={'/uz'} className='hover:text-blue-600 transition decoration-[1px] hover:underline'>Bosh sahifa</Link>
        <Link to={'/uz/courses'} className='hover:text-blue-600 transition decoration-[1px] hover:underline'>Kurslar</Link>
        <Link to={'/uz/treyding'} className='hover:text-blue-600 transition decoration-[1px] hover:underline'>Treyding</Link>
        <Link to={'/uz/contacts'} className='hover:text-blue-600 transition decoration-[1px] hover:underline'>Aloqa</Link>
      </ul>
      </div>
      <div className="flex gap-2 items-center">
