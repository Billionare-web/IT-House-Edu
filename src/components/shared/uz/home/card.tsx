  ...
  return (
    <div className="mt-3">
      <div className="flex justify-center mt-14">
        <div className="flex items-center gap-28 max-[380px]:flex-col max-[380px]:gap-5">
          <div className="column px-32">
          ...
          <div className="flex max-[380px]:flex-col gap-5 w-full">
            <Link
              to={"/uz/courses"}
      ...
      <div className="max-[380px]:owerflow-hidden">
      <Carousel className="mt-5 max-[380px]:px-10">
        <CarouselContent className="max-[380px]:flex-col gap-5">
          ...
          <CarouselItem className="basis-1/2">
            <div className="border-2 rounded-2xl">
              <img
                ...
                alt=""
              />
              <h1 className="font-bold text-3xl px-3 max-sm:text-xl">Phyton</h1>
              <hr className="my-3 mx-3" />
              <div className="flex justify-between">
                <h1 className="font-semibold px-3 pt-1 pb-5 max-sm:[]">
                  Django, Postgresql, <span className="max-sm:text-">Djangorest framework, JS,</span>...
                </h1>
                <h1 className="text-gray-500 text-xs font-semibold">
                  <s>
                    1,200,000
