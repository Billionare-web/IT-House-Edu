...
function Hamkorlar() {
  return (
    <Carousel
      className="sm:mt-24 bg-secondary py-2 w-full h-20  px-20 "
      opts={{
        loop: true,
      }}
      plugins={[
