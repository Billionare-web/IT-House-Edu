      ...
      <div className="w-full mx-5 my-3 rounded-md bg-secondary px-4 pb-4">
        <div className="pt-4">
          ...
          <p className="text-sm font-medium text-muted-foreground">
            Hisobingiz va buyurtmalaringiz haqida yangiliklar va yangilanishlar
          </p>
        </div>
        <div className="mt-10 flex w-full flex-col items-center justify-center">
          ...
          <h2 className="mt-8 font-space-grotesk text-2xl font-bold">
            Ko'rsatiladigan bildirishnomalar yo'q
          </h2>
          <p className="my-3.5 max-w-md text-center">
            Siz hali hech qanday bildirishnomani olishmadingiz. 🚀 Kutilmoqda!
            💡
          </p>
        </div>
