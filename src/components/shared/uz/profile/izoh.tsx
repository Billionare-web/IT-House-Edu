  ...
  return (
    <div className="flex w-full">
      ...
      <div className="w-full mx-5 my-3 rounded-md bg-secondary px-4 pb-4">
        <div className="pt-4">
          <h1 className="font-space-grotesk text-4xl font-bold">baholash</h1>
          <p className="text-sm font-medium text-muted-foreground">
            Sevimli mahsulotlar va xizmatlar haqida izohlar o'qib va yozing.
          </p>
        </div>
        <div className="mt-10 flex w-full flex-col items-center justify-center">
          ...
          <h2 className="mt-8 font-space-grotesk text-2xl font-bold">
            Ko'rsatish uchun hech qanday sharhlar mavjud emas
          </h2>
          <p className="my-3.5 max-w-md text-center">
            Ushbu kurs uchun ko'rsatish uchun hech qanday sharhlar mavjud emas.
            🚀 Ushbu kursga birinchi sharhni qoldiring. Har bir aloqa biz uchun
            muhim! 💡
          </p>
        </div>
        <div className="mt-4 flex max-w-xl flex-col space-y-3"></div>
      </div>
    </div>
  );
}
